...
class QuantityDialog(QDialog):
    def __init__(self, parent=None, title="Test Pairs", text="How many pairs will be in you test list: ", default_value=1):
        ...
        self.spin_box.setValue(default_value)        # default value
