...
class SetFinderUI(BaseTab):
    ...
    def init_ui(self):
        ...
        strategy_label_layout.setAlignment(Qt.AlignTop )
        strategy_label_layout.setSpacing(2)
        strategy_label=QLabel("Strategy Test Information:")
        strategy_label.setAlignment(Qt.AlignCenter)
        strategy_label.setStyleSheet("font-size:20px; color:#444;")
        ...
        self.reset_button.setMinimumWidth(250)
